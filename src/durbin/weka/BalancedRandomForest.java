 ...
 *
 *    BalancedRandomForest.java 
 * 		Modified from RandomForest by James Durbin, UC Santa Cruz (C) 2011
 * 
 *    Based on "Using Random Forest to Learn Imbalanced Data" by Chao Chyen, Andy Liaw, and Leo Breiman. 
 *
...
public class BalancedRandomForest 
  ...
  public String numFeaturesTipText() {
    return "The number of attributes to be used in random selection (see BalancedRandomTree).";
  }
  ...
  public double getMeasure(String additionalMeasureName) {
    ...
    if (additionalMeasureName.equalsIgnoreCase("measureOutOfBagError")) {
      return measureOutOfBagError();
					     ...
					     + " not supported (BalancedRandomForest)");
    }
  }
  ...
  public Capabilities getCapabilities() {
    return new BalancedRandomTree().getCapabilities();
  }
