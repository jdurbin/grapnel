 ...
 *    MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See thesseed
 ...
 * 
 *    BalancedRandomTree.java
 *    Modified from RandomTree.java by James Durbin, UC Santa Cruz
 *    (2011)
 *
 *
 */
 ...
 */
public class BalancedRandomTree extends Classifier implements OptionHandler,
WeightedInstancesHandler, Randomizable, Drawable {
  ...
  protected BalancedRandomTree[] m_Successors;
  ...
  public boolean getAllowUnclassifiedInstances() {
	...
	public boolean getDownsampleMajor(){
		return m_DownsampleMajor;
	}
  ...
  public void setAllowUnclassifiedInstances(boolean newAllowUnclassifiedInstances) {
	...
	public void setDownsampleMajor(boolean newDownsampleMajor){
		m_DownsampleMajor = newDownsampleMajor;
	}
  ...
  public Enumeration listOptions() {
    ...
    newVector.addElement(new Option("\tSeed for random number generator.\n"
	  ...
	  newVector.addElement(new Option("\tBootstrap fraction for minor class.\n"
	        + "\t(default 1.0)", "B", 1, "-B <num>"));
    ...
    newVector.
      addElement(new Option("\tAllow unclassified instances.",
		...
		newVector.
		      addElement(new Option("\tDownsmple major (vs resample minor).",
					    "D", 0, "-D"));
  ...
  public String[] getOptions() {
    ...
    result.add("" + getMinNum());
		...
		result.add("-B");
		result.add(""+getBootstrapFraction());
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    if (numFoldsString.length() != 0) {
      ...
      m_NumFolds = 0;
		...
		setDownsampleMajor(Utils.getFlag('D',options));
  ...
  protected String toString(int level) {
    ...
    try {
      ...
      e.printStackTrace();
      return "BalancedRandomTree: tree can't be printed";
    }
  }
  ...
  protected void buildTree(Instances data, double[] classProbs, Instances header,
    ...
    if (Utils.gr(vals[m_Attribute], 0)) {
      ...
      Instances[] subsets = splitData(data);
      m_Successors = new BalancedRandomTree[distribution.length];
      for (int i = 0; i < distribution.length; i++) {
        m_Successors[i] = new BalancedRandomTree();
  ...
  public static void main(String[] argv) {
    runClassifier(new BalancedRandomTree(), argv);
  }
  ...
  public String graph() throws Exception {
    ...
    if (m_Successors == null) {
      throw new Exception("BalancedRandomTree: No model built yet.");
    }
    StringBuffer resultBuff = new StringBuffer();
    toGraph(resultBuff, 0, null);
    String result = "digraph BalancedRandomTree {\n" + "edge [style=bold]\n"
    + resultBuff.toString() + "\n}\n";
    return result;
  }
   ...
   *             if something goes wrong
   */
  protected int toGraph(StringBuffer text, int num, BalancedRandomTree parent)
  throws Exception {

    num++;
    if (m_Attribute == -1) {
      text.append("N" + Integer.toHexString(BalancedRandomTree.this.hashCode())
      ...
      for (int i = 0; i < m_Successors.length; i++) {
        text.append("N"
            + Integer.toHexString(BalancedRandomTree.this.hashCode())
            + "->" + "N"
            + Integer.toHexString(m_Successors[i].hashCode())
            + " [label=\"");
        if (m_Info.attribute(m_Attribute).isNumeric()) {
